...
dam.data.nc <- read.csv("ARDamRemovalList_Figshare_Feb2021.csv") %>% filter(State == "NC") %>% select(Dam_Name:State) %>% na.omit()
falls.lake <- read.csv("falls_lake.csv")
counties_sf <-  st_read('/Users/cheneygardner/Desktop/Env872/Env872-Final-Project/spatial_nc/cb_2018_us_county_20m.shp') %>% filter(STATEFP == 37)
